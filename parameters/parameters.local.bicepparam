...
param environment = 'local' // consider using another parameter for local deployments
param tags = {
  Environment: 'Local' // consider using another parameter for local deployments
...
param coreProjectName = 'platform-core' // platform resource group
param spokeProjectName = 'web-apps' // application resource group
